...
const openToColors = ["#D42B2B", "#1B4FD8", "#F0C225", "#111111", "#D42B2B"];
...
export function Contact() {
  ...
  const copyEmail = async () => {
    const email = "lochanftw@gmail.com";
    try {
      await navigator.clipboard.writeText(email);
      setCopied(true);
      setTimeout(() => setCopied(false), 2500);
    } catch {
      // Fallback for non-HTTPS / sandboxed iframe environments
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="space-y-4">
              ...
              >
                {link.href ? (
                  <a
                    ...
                    style={{ border: "1.5px solid #E8E8E0", textDecoration: "none" }}
                  >
            ...
            <motion.button
              ...
              style={{
                backgroundColor: copied ? "#D42B2B" : "#111111",
                border: "2px solid",
                borderColor: copied ? "#D42B2B" : "rgba(17,17,17,0.8)",
                fontFamily: "var(--font-body)",
                fontWeight: 600,
                fontSize: "13px",
                ...
                boxShadow: copied ? "0 0 24px rgba(212,43,43,0.5), 0 0 60px rgba(212,43,43,0.2)" : "none",
              }}
              initial={{ opacity: 0 }}
              animate={inView ? { opacity: 1 } : {}}
              transition={{ delay: 0.9 }}
              whileTap={{ scale: 0.97 }}
              whileHover={!copied ? { boxShadow: "0 0 20px rgba(17,17,17,0.3)" } : {}}
            >
              <span style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px" }}>
                <motion.span
                  animate={{ rotate: copied ? 360 : 0, scale: copied ? [1, 1.4, 1] : 1 }}
                  ...
                  style={{
                    ...
                    height: 8,
                    borderRadius: "50%",
                    backgroundColor: copied ? "#FFFFFF" : "#D42B2B",
                    flexShrink: 0,
                  }}
                />
                ...
                {openTo.map((item, i) => (
                  ...
                  >
                    <motion.div
                      ...
                      style={{ backgroundColor: openToColors[i] }}
