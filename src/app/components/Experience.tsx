...
const experiences = [
  ...
  },
  {
    ...
    location: "Puducherry, India · Offline",
    duration: "1 Month",
    period: "2026",
    color: "#1B4FD8",
    shape: "square",
    bullets: [
      "Researched image processing techniques including Image Restoration, Morphological Processing, Image Segmentation, and Feature Extraction & Classification.",
      "Developed an object detection pipeline focused on identifying diseases in fish and monitoring the health of marine life using computer vision algorithms.",
      "Applied deep-learning and classical vision methods to analyse aquatic specimens, contributing to early-stage research in marine biology and underwater surveillance.",
    ],
    skills: ["Image Processing", "Object Detection", "OpenCV", "Computer Vision", "Python", "Marine Life Research"],
  },
];
