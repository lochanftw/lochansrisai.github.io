...
const paragraphs = [
  ...
  "In 2026, I pursued a research internship at NIT Puducherry, diving deep into Image Processing and Object Detection. I studied Image Restoration, Morphological Processing, Image Segmentation, and Feature Extraction & Classification. My primary project centred on detecting diseases in fish and monitoring marine life health using computer vision — an experience that sharpened my ability to solve real-world problems through visual intelligence.",
          ...
          <div className="relative">
            ...
            >
              <div className="relative w-full max-w-sm">
                ...
                <div className="relative z-10 p-8" style={{ backgroundColor: "#111111" }}>
                  <div
                    style={{
                      fontFamily: "var(--font-display)",
                      fontSize: "80px",
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-8 h-8 flex-shrink-0" style={{ backgroundColor: "#D42B2B" }} />
                    <div>
